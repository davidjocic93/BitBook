...
const ImagePostComponent = (props) => {
    ...
    const { id, dateCreated, userId, userDisplayName, type, commentsNum, imageUrl } = props.post;
    const ownId = parseInt(props.ownId, 10);
    ...
    return (
        ...
        <div className="container feed">
            <button className="deleteBtn" onClick={onDeletion} style={{ display: showDeleteButton }}>
                <img src="http://www.pvhc.net/img5/kvqqrcmmwflsdfarwewp.png" alt="delete button"/>
            </button>
            <div className="row postContainer">
                ...
                <div className="col-12">
                    <img className="imagePostImage" src={imageUrl} onClick={handlerFunction} style={{ width: "100%" }} alt="delete button"/>
