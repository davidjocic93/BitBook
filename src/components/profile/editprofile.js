        ...
        return (
            ...
            <div>
                ...
                <button type="button" className="editProfile" onClick={this.activateModal}>
                    <img src="https://image.flaticon.com/icons/png/128/149/149307.png" width="50px" alt="edit profile button"/>
                </button>

                <Modal className="Modal__Bootstrap edit-profile-modal modal-dialog" ariaHideApp={false} isOpen={this.state.isOpen} style={{ overlay: { zIndex: 2000 } }}>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="profileImagePreviewContainer">
                                <img className="profileImagePreview" src={this.state.imagePreviewUrl ? this.state.imagePreviewUrl : this.state.avatarUrl} alt="profile img preview"/>
                            </div>
