                    ...
                    <div className="row">
                        ...
                        <div className="col-1 sendComment">
                            <button type="button" onClick={this.postComment}>
                                <img src="https://image.flaticon.com/icons/png/512/60/60525.png" alt="textPostButton"/>
                            </button>
                        </div>
                ...
                <div>
                    ...
                    <div className="container feedContainer">
                        ...
                        <div className="row">
                            ...
                            <div className="col-1 sendComment">
                                <button type="button" onClick={this.postComment}>
                                    <img src="https://image.flaticon.com/icons/png/512/60/60525.png" alt="imagePostButton"/>
                                </button>
                            </div>
        ...
        return (
            ...
            <div className="container feedContainer">
                ...
                <div className="row">
                    ...
                    <div className="col-1 sendComment">
                        <button type="button" onClick={this.postComment}>
                            <img src="https://image.flaticon.com/icons/png/512/60/60525.png" alt="videoPostButton"/>
                        </button>
                    </div>
